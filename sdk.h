...
#define CSGO_VERSION XorStr("1.35.6.0")
#define CSGO_CLIENT_VERSION 411
...
#define m_angEyeAngles 0xAA08
#define m_iHealth 0xFC
#define m_ArmorValue 0xAA04
#define m_iShotsFired 0xA2C0
#define m_iCrossHairID 0xAA70
